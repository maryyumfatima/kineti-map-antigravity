      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <button
            ...
            className="bg-primary hover:opacity-90 text-white px-4 py-2 rounded-lg font-medium flex items-center gap-2 transition-colors text-sm"
          >
        ...
        <div className="bg-card rounded-xl border border-border overflow-hidden shadow-sm">
          {loading ? (
            <div className="p-12 text-center text-text/70 text-sm">Loading sessions...</div>
          ) : bookings.length === 0 ? (
            <div className="p-16 flex flex-col items-center justify-center text-text/50">
              <Calendar className="w-12 h-12 mb-4 opacity-20" />
              <p className="font-medium text-text/70">No sessions yet.</p>
            </div>
          ) : (
